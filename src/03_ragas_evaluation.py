...
# Compatibility shim: langchain-community 0.4.x removed chat_models.vertexai
# ragas 0.4.x still imports from that path — patch sys.modules before import
import sys, types as _types
_vertexai_path = "langchain_community.chat_models.vertexai"
if _vertexai_path not in sys.modules:
    try:
        import importlib
        importlib.import_module(_vertexai_path)
    except ImportError:
        _stub = _types.ModuleType(_vertexai_path)
...
SYSTEM_V1 = (
    "Bạn là trợ lý AI hữu ích. Trả lời ngắn gọn và rõ ràng dựa trên context được cung cấp (2-4 câu). "
...
SYSTEM_V2 = (
    "Bạn là chuyên gia phân tích thông tin. Đọc kỹ context bên dưới, xác định các facts liên quan, "
    "rồi viết câu trả lời rõ ràng có cấu trúc (3-5 câu). "
    "Luôn căn cứ vào dữ liệu được cung cấp, không suy đoán thêm. "
    "Nếu context không đủ thông tin, hãy nêu rõ điều đó.\n\n"
    "Context:\n{context}"
)
